...
spanish_stop_words = [
    ...
    'estuve', 'estuvo', 'estado', 'he', 'has', 'ha', 'hemos', 'han', 'soy', 'es', 'son', 'eres'
]
...
conn_str = (
    ...
    r'DBQ=C:\Users\decanatura.ingenieri\Desktop\vsCode\ParaPython(2)1.accdb;'
)
...
for similarity_threshold in [0.05, 0.10, 0.15, 0.20, 0.25]:
    for fut_similarity_threshold in [0.05, 0.10, 0.15, 0.20, 0.25]:
